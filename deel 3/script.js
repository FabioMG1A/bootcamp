...
function instruction9() {
    ...
    img.src = "photo.jpg";
    var src = document.getElementById("instructionResult");
...
function alertButtonL() {
  // 1. Create the button
  var button = document.createElement("button");
  button.innerHTML = "Left";

  // 2. Append somewhere
  var instructionResult = document.getElementById("instructionResult");
  instructionResult.appendChild(button);

  // 3. Add event handler
  button.addEventListener ("click", function() {
    alert("This is the left button.");
  });
}

function alertButtonR() {
  // 1. Create the button
  var button = document.createElement("button");
  ...
  // 3. Add event handler
  button.addEventListener ("click", function() {
    alert("This is the right button.");
  });
}
